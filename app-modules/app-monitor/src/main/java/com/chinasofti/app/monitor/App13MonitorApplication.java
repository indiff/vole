package com.chinasofti.app.monitor;
...
public class App13MonitorApplication {

    public static void main(String[] args) {
        log.debug("App13MonitorApplication startup main");
        SpringApplication application = new SpringApplication(App13MonitorApplication.class);
